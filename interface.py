...
class TreeFrame(Frame):
    ...
    def draw_tree(self, tree, highlight, annotation, annotationBox):
        ...
        bbox = self._draw_node(root_node, tree, highlight, annotation, annotationBox, 12, 12)
    ...
    def _draw_node(self, node, tree, highlight, annotation, annotationBox, x1, y1):
        ...
        button.bind('<Button-1>', lambda event: self._on_click(node, annotation, annotationBox))
        button.bind('<Enter>', lambda event: self._on_hover(node, highlight))
...
def run():
    ...
    qepGraphicframe.draw_tree(treeQEP, treeQEP_highlight, treeQEP_annotation, qepAnnotationBox)
    ...
    aqpGraphicframe.draw_tree(treeAQP, treeAQP_highlight, treeAQP_annotation, aqpAnnotationBox)
    ...
    qepGraphicframe.set_on_click_listener(on_click_listener, treeQEP_annotation, qepAnnotationBox)
    qepGraphicframe.set_on_hover_listener(on_hover_listener, treeQEP_highlight)
    qepGraphicframe.set_on_hover_end_listener(on_hover_end_listener)

    aqpGraphicframe.set_on_click_listener(on_click_listener, treeAQP_annotation, aqpAnnotationBox)
...
qepAnnotationBox = AnalysisFrame(root)
aqpAnnotationBox = AnalysisFrame(root)
### ======================================= ###
...
#                         state="disabled", bg='lightgray')
aqpGraphicframe = TreeFrame(root)
